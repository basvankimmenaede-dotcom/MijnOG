  ...
  return (<>
    ...
    <section>
      ...
      <div className="settings-list">
        ...
        <SettingsRow icon="info" title="Over Mijn OG" subtitle="Versie 3.0.0.13" onClick={() => setSettingsView('about')} />
      </div>
