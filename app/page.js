  ...
  return (<>
    ...
    <section>
      ...
      <div className="settings-list">
        ...
        <SettingsRow icon="info" title="Over Mijn OG" subtitle="Versie 2.9.9.3" onClick={() => setSettingsView('about')} />
      </div>
